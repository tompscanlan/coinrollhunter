...
type ItemType struct {
	ID int64 `json:"id"`
	// UID is this catalog entry's permanent identity (ADR-009, migration 0010):
	// opaque, generated by the store at insert, never recycled by a delete. It is
	// what an exported lot points at to say *which coin type it is* — the id is a
	// rowid alias and cannot carry that meaning across a delete or a reimport.
	UID        string  `json:"uid"`
